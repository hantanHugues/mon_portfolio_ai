    ...
    <div className="flex h-screen bg-background">
      ...
      <div className="w-[480px] border-r bg-card flex flex-col">
        <div className="p-4 border-b">
          <h1 className="text-lg font-bold mb-1">Générateur CV</h1>
        ...
        <Tabs defaultValue="config" className="flex-1 flex flex-col overflow-hidden">
          <TabsList className="grid grid-cols-3 mx-4 mt-1 mb-1">
            <TabsTrigger value="config" className="gap-2 text-xs py-2">
              <Settings className="h-3.5 w-3.5" />
              Config
            </TabsTrigger>
            <TabsTrigger value="projects" className="gap-2 text-xs py-2">
              <Code className="h-3.5 w-3.5" />
              Projets
            </TabsTrigger>
            <TabsTrigger value="skills" className="gap-2 text-xs py-2">
          ...
          <div className="flex-1 overflow-y-auto px-4 pb-4">
            <TabsContent value="config" className="mt-2 h-full">
            ...
            <TabsContent value="projects" className="mt-1 h-full">
              <div className="space-y-3">
            ...
            <TabsContent value="skills" className="mt-1 h-full">
              <div className="space-y-4">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-semibold flex items-center gap-2">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <Progress value={skill.level} className="h-2 mb-3 [&>div]:bg-muted-foreground/30" />
